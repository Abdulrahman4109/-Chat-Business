...
## Step 8 — Session Restoration (Optional)

إذا عاد المستخدم إلى محادثة قديمة:

1. النظام يسترجع آخر البيانات من المحادثة السابقة
2. يسأل: "هل تريد استعادة بياناتك السابقة؟"
3. إذا أجاب "نعم" ← يتم تعبئة جميع الحقول بقيم الجلسة السابقة وحساب النتيجة
4. إذا أجاب "لا" ← تبدأ محادثة جديدة من الصفر

---

## Step 9 — Diagram (Optional)
...
| 8. استعادة الجلسة | استرجاع بيانات سابقة | لا |
| 9. الرسم البياني | توليد خريطة draw.io | لا |
